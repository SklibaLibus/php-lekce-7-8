...
class ProgrammingLanguageController extends AbstractController
{
    ...
    /**
     * @Route("/known", name="known", methods="GET")
     */
    public function findKnown(ProgrammingLanguageRepository $programmingLanguageRepository)
    {
        $pr = $programmingLanguageRepository->findKnown();
